...
Invoke-WebRequest -Uri  "https://github.com/RedGuyyyy/sd2snes/releases/download/usb2snes_v10/usb2snes_v10.zip" -OutFile "usb2snes.zip"
...
Copy-Item usb2snes_v10/sd2snes/ -Destination .\QUsb2Snes\FIRMWARE -Recurse
Copy-Item usb2snes_v10/win7_driver/ -Destination .\QUsb2Snes\FIRMWARE -Recurse
Copy-Item usb2snes_v10/readme.txt -Destination .\QUsb2Snes\FIRMWARE\
...
Copy-Item usb2snes_v10\apps\MemoryViewer -Destination .\QUsb2Snes\apps\MemoryViewer -Recurse
